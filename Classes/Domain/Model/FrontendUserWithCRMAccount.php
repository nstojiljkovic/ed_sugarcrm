...
class FrontendUserWithCRMAccount extends \EssentialDots\ExtbaseDomainDecorator\Domain\Model\AbstractFrontendUser {
	...
	/**
	 * @param \EssentialDots\EdSugarcrm\Domain\Model\Account $crmAccount
	 */
	public function setCrmAccount($crmAccount) {
