...
class FrontendUserController extends \TYPO3\CMS\Extbase\Mvc\Controller\ActionController {
	...
	/**
	 * @param \EssentialDots\ExtbaseDomainDecorator\Domain\Model\AbstractFrontendUser $user
	 */
	public function showAction(\EssentialDots\ExtbaseDomainDecorator\Domain\Model\AbstractFrontendUser $user = NULL) {
		if (!$user) {
